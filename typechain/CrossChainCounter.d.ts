...
interface CrossChainCounterInterface extends ethers.utils.Interface {
  functions: {
...
export class CrossChainCounter extends BaseContract {
  ...
  functions: {
    ...
    addChainSupport(
      ...
      _crossChainIncrementorAddress: BytesLike,
